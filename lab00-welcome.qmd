...
![BMI chart](img/bmi.jpg){width="400px"}
</center>
...
![Data should be tidy, like your room](img/tidy.png){width="200px"}
</center>
...
**Title** + other details - descriptive title, set in the YAML (“YAML ain’t Markup Language”: recursive acronym…) header
