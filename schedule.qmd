...
+=============+============================================================================================================+=================================================+===========================+
| Mon         | [![](img/pptx.png){width="25" height="23"}](lectures/00-module-intro.pptx) 00 Module overview              | [Lab guidance](lab00-guidance.html)             | James et al. 2021 Ch 1,2  |
|             |                                                                                                            |                                                 |                           |
|             | [![](img/pptx.png){width="25" height="23"}](lectures/01-introduction.pptx) 01 Introduction                 | [Lab 01 Linear algebra fun](lab01-lin-alg.html) | Efron 2020                |
|             |                                                                                                            |                                                 |                           |
|             | [![](img/pptx.png){width="25" height="23"}](lectures/02-statistical-learning.pptx) 02 Statistical learning | Lab 02 R programming refresh                    |                           |
+-------------+------------------------------------------------------------------------------------------------------------+-------------------------------------------------+---------------------------+
| Tues        | [![](img/pptx.png){width="25" height="23"}](lectures/03-linear-regression.pptx) 03 Linear regression       | Lab 03 Linear regression                        | James et al. 2021 Ch 3,4  |
|             |                                                                                                            |                                                 |                           |
|             | [![](img/pptx.png){width="25" height="23"}](lectures/04-classification.pptx) 04 Classification             | Lab 04 Classification                           | Melesse 2018              |
+-------------+------------------------------------------------------------------------------------------------------------+-------------------------------------------------+---------------------------+
| Wed         | [![](img/pptx.png){width="25" height="23"}](lectures/05-crossval-bootstrap.pptx) 05 Bootstrapping          | Lab 05 Resampling                               | James et al. 2021 Ch 5,6  |
|             |                                                                                                            |                                                 |                           |
|             | 06 Model selection                                                                                         | Lab 06 Model selection                          | Aho 2014                  |
+-------------+------------------------------------------------------------------------------------------------------------+-------------------------------------------------+---------------------------+
| Thurs       | 07 Non-linear models                                                                                       | Lab 07 Non-linear models                        | James et al. 2021 Ch 7,8  |
|             |                                                                                                            |                                                 |                           |
|             | 08 Decision trees                                                                                          | Lab 08 Decision trees                           | Barnard 2019              |
|             |                                                                                                            |                                                 |                           |
|             |                                                                                                            |                                                 | Otukei 2010               |
+-------------+------------------------------------------------------------------------------------------------------------+-------------------------------------------------+---------------------------+
| Fri         | 09 Support vector machines                                                                                 | Lab 09 SVM                                      | James et al. 2021 Ch 9,12 |
|             |                                                                                                            |                                                 |                           |
